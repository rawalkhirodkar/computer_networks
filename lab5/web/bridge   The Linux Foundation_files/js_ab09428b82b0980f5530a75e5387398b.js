...
$('.views_slideshow_slide .views-row .views-field-field-home-slide-photo-fid img').hide();
$('.views_slideshow_slide .views-row .views-field-field-home-slide-photo-fid').each(function(index){
	var imgPull = $(this).find('img').attr('src');
	$(this).css('background-image', 'url(' + imgPull + ')');
});

function hidePreviousButton() {
  if ($('#views_slideshow_singleframe_div_homepage_slideshow-page_1_0').css('display') == 'block') {
    // On the first homepage slide, hide the previous control (left arrow).
    $("#views_slideshow_singleframe_prev_homepage_slideshow-page_1").css({"visibility": "hidden"});
  }
  else {
    // Show the previous control (left arrow) on all other slides.
    $("#views_slideshow_singleframe_prev_homepage_slideshow-page_1").css({"visibility": "visible"});
  }
};
